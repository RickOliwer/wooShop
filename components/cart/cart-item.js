...
import { deleteCartItem, updateCart } from '../../src/utils/cart';
...
const CartItem = ( {
	...
	return (
		<div className="grid grid-cols-3 gap-6 p-5 mb-5 border cart-item-wrap border-brand-bright-grey">
			...
			<div className="col-span-2 cart-right-col">
				<div className="flex flex-col justify-between h-full">
					<div className="relative cart-product-title-wrap">
						...
						<button className="absolute top-0 right-0 flex items-center px-4 py-2 bg-transparent border cart-remove-item text-22px leading-22px border-brand-bright-grey" onClick={ ( event ) => handleRemoveProductClick( event, item?.key ) }>&times;</button>
					</div>
					
					<footer className="flex justify-between p-4 border-t cart-product-footer border-brand-bright-grey">
						<div className="">
