...
const CartItemsContainer = () => {
	...
	return (
		<div className="content-wrap-cart">
			{ cart ? (
				<div className="grid gap-4 woo-next-cart-table-row lg:grid-cols-3">
					{/*Cart Items*/ }
					<div className="mb-5 woo-next-cart-table lg:col-span-2 mb-md-0">
						{ cartItems.length &&
						cartItems.map( ( item ) => (
							<CartItem
								key={ item.product_id }
					...
					{/*Cart Total*/ }
					<div className="p-5 pt-0 woo-next-cart-total-container lg:col-span-1">
						<h2>Cart Total</h2>
						<div className="grid grid-cols-3 mb-4 bg-gray-100">
